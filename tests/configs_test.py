...
INFERENCE_CONFIGS = [ 
    ...
    os.path.join(MAXTEXT_REPO_ROOT, "src", "MaxText", "inference", "configs", "multi_host", "disaggregation", "llama3_405b_v6e-16-16.yml"), 
    os.path.join(MAXTEXT_REPO_ROOT, "src", "MaxText", "inference", "configs", "multi_host", "interleaved", "llama2_70b_v5e-16.yml"), 
    os.path.join(MAXTEXT_REPO_ROOT, "src", "MaxText", "inference", "configs", "multi_host", "interleaved", "llama3_70b_v5e-16.yml"), 
    os.path.join(MAXTEXT_REPO_ROOT, "src", "MaxText", "inference", "configs", "multi_host", "interleaved", "llama3_405b_v5e-64.yml"), 
] 
