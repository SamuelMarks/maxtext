...
from MaxText.globals import PKG_DIR, ASSETS_ROOT, TEST_ASSETS_ROOT
...
def get_golden_data(config):
  ...
  input_golden_data_path = os.path.join(TEST_ASSETS_ROOT, f"golden_data_grpo_{config.model_name}.jsonl")
...
class GrpoTrainerTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    self.config = pyconfig.initialize(
        ...
        tokenizer_path=os.path.join(ASSETS_ROOT, "llama3.1-tokenizer"),
