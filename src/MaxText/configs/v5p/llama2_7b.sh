...
# bash maxtext/configs/v5p/llama2_7b.sh EXECUTABLE=train_compile M_COMPILE_TOPOLOGY=v5p-512 M_COMPILE_TOPOLOGY_NUM_SLICES=1
...
python3 -m maxtext.$EXECUTABLE src/maxtext/configs/base.yml model_name=llama2-7b\
