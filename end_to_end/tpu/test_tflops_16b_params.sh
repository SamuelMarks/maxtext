#!/bin/bash
echo "Running test_tflops_16b_params.sh"
...
# bash end_to_end/tpu/test_tflops_16b_params.sh RUN_NAME="<your_run_name>"" OUTPUT_PATH="gs://<your_output_path>" DATASET_PATH="gs://<your_dataset_path>" PLATFORM="gke" TFLOP_THRESHOLD=0
