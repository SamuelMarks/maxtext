...
JAX_PLATFORMS=cpu python3 -m maxtext.generate_param_only_checkpoint maxtext/configs/base.yml async_checkpointing=false base_output_directory=${BASE_OUTPUT_PATH} load_parameters_path=${CONVERTED_CHECKPOINT} run_name=${RUN_NAME} model_name='llama3-8b' force_unroll=true
