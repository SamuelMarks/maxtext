...
# tfds pipeline
python3 -m maxtext.train src/maxtext/configs/dpo.yml tokenizer_path=assets/tokenizer.gemma \
...
# hf pipeline
python3 -m maxtext.train src/maxtext/configs/dpo.yml tokenizer_path='google/gemma-2-2b-it' \
    run_name="$RUN_NAME-grain" model_name=gemma2-2b base_output_directory=${LOGS} \
    load_parameters_path=${GEMMA_2B_CKPT_PATH}/0/items \
