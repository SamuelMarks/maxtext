...
echo
$cmd python3 -m maxtext.train src/maxtext/configs/base.yml \
...
$cmd python3 -m maxtext.generate_param_only_checkpoint src/maxtext/configs/base.yml \
...
echo
$cmd python3 -m maxtext.decode src/maxtext/configs/base.yml \
